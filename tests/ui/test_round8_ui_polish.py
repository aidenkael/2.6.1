...
class TestUserCorrectionExampleLayer:
    def test_example_visible_when_empty_with_single_line(self, shown_page, qapp):
        ...
        assert "填写用于重估的修正（本框内容优先）" in edit.example.text()
        assert "若商品识别错误" not in edit.example.text()
